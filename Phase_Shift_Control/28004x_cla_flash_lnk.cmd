...
/* Flash sectors */
   ...
   FLASH_BANK0_SEC2_3_4  : origin = 0x082000, length = 0x003000	/* on-chip Flash */
  // FLASH_BANK0_SEC3  : origin = 0x083000, length = 0x001000	/* on-chip Flash */
   //FLASH_BANK0_SEC4  : origin = 0x084000, length = 0x001000	/* on-chip Flash */
   FLASH_BANK0_SEC5_6_7  : origin = 0x085000, length = 0x003000	/* on-chip Flash */
...
SECTIONS
{
   .cinit           : > FLASH_BANK0_SEC5_6_7,     PAGE = 0, ALIGN(4)
   .text            : >>FLASH_BANK0_SEC1|FLASH_BANK0_SEC2_3_4 ,   PAGE = 0, ALIGN(4)
   ...
   .const           : > FLASH_BANK0_SEC8,       PAGE = 0,       ALIGN(4)
#else
   .pinit           : > FLASH_BANK0_SEC1,       PAGE = 0,       ALIGN(4)
   .ebss            : >>RAMGS3|RAMGS2|RAMGS1|RAMGS0,       PAGE = 1
   .esysmem         : > RAMGS3|RAMGS2|RAMGS1|RAMGS0,       PAGE = 1
   .cio             : > RAMGS3|RAMGS2|RAMGS1|RAMGS0,       PAGE = 1
   .econst          : > FLASH_BANK0_SEC10,    PAGE = 0, ALIGN(4)
#endif
	dclfuncs		: > FLASH_BANK0_SEC13		PAGE = 0, ALIGN(4)
	dcl32funcs		: > FLASH_BANK0_SEC13		PAGE = 0, ALIGN(4)
...
#if defined(__TI_EABI__)
    Cla1Prog        : LOAD = FLASH_BANK0_SEC5_6_7,
                      RUN = RAMLS0,
...
#if defined(__TI_EABI__)
       .TI.ramfunc   :LOAD = FLASH_BANK0_SEC5_6_7,
                      RUN = RAMLS4_7
...
#if defined(__TI_EABI__)
   .const_cla      : LOAD = FLASH_BANK0_SEC5_6_7,
                      RUN = RAMLS3,
